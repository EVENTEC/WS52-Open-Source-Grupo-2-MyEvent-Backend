...
public record CreateEventCommand(String name, String date, String organizer, String location, Boolean resale, String description, Double price, Integer capacity, String image, String category, String eventApiKey) {
